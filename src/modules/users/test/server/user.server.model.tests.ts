...
import { Express } from "../../../../config/lib/express";
import * as chai from "chai";
import * as server from "../../../../server";
const expect = chai.expect;
const should = chai.should();
import { default as User, UserModel } from "../../server/models/User";
...
describe("User Model Unit Tests:", function () {
  ...
  describe("User Password Validation Tests", function () {
    ...
    it("should validate a randomly generated passphrase from the static schema method", function () {
      ...
      userModel.generateRandomPassphrase()
  ...
  describe("User E-mail Validation Tests", function () {
    ...
    it("should not allow invalid email address - \"abc@abc@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should not allow invalid characters in email address - \"abc~@#$%^&*()ef=@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should not allow space characters in email address - \"abc def@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should not allow doudble quote characters in email address - \"abc\"def@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should not allow double dotted characters in email address - \"abcdef@abc..co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should allow single quote characters in email address - \"abc\"def@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should allow valid email address - \"abc@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should allow valid email address - \"abc+def@abc.co\"", function (done) {
      const _user1 = new User(user1);
    ...
    it("should allow valid email address - \"abc.def@abc.def.co\"", function (done) {
      const _user1 = new User(user1);
  ...
  after(function (done) {
    User.remove(undefined).exec(done);
  });
